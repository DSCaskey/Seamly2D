...
{
    ToolSelectPointByRelease();
    SetToolButtonWithApply<IntersectCircleLineDialog>
    (
        checked, Tool::PointOfContact,
        ":/cursor/point_intersect_circle_line_cursor.png",
        tr("<b>Tool::Point - Intersect Arc and Line:</b> Select first point of line"),
        &MainWindow::ClosedDrawDialogWithApply<IntersectCircleLineTool>,
        &MainWindow::ApplyDrawDialog<IntersectCircleLineTool>
    );
}
...
void MainWindow::handlePointsMenu()
{
    ...
    QAction *action_PointOfContact      = menu.addAction(QIcon(":/toolicon/32x32/point_intersect_circle_line.png"),       tr("Intersect Arc and Line") + "\tA, L");
