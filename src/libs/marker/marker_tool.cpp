...
const quint8 MarkerTool::pieceVersion = 2;

const QString MarkerTool::TagCSA     = QStringLiteral("csa");
const QString MarkerTool::TagRecord  = QStringLiteral("record");
const QString MarkerTool::TagIPaths  = QStringLiteral("iPaths");
const QString MarkerTool::TagAnchors = QStringLiteral("anchors");

const QString MarkerTool::AttrVersion              = QStringLiteral("version");
const QString MarkerTool::AttrForbidFlipping       = QStringLiteral("forbidFlipping");
const QString MarkerTool::AttrPieceColor           = QStringLiteral("color");
const QString MarkerTool::AttrPieceFill            = QStringLiteral("fill");
const QString MarkerTool::AttrPieceLock            = QStringLiteral("locked");
const QString MarkerTool::AttrSeamAllowance        = QStringLiteral("seamAllowance");
const QString MarkerTool::AttrHideSeamLine         = QStringLiteral("hideMainPath");
const QString MarkerTool::AttrSeamAllowanceBuiltIn = QStringLiteral("seamAllowanceBuiltIn");
const QString MarkerTool::AttrHeight               = QStringLiteral("height");
const QString MarkerTool::AttrUnited               = QStringLiteral("united");
const QString MarkerTool::AttrFont                 = QStringLiteral("fontSize");
const QString MarkerTool::AttrTopLeftAnchor        = QStringLiteral("topLeftAnchor");
const QString MarkerTool::AttrBottomRightAnchor    = QStringLiteral("bottomRightAnchor");
const QString MarkerTool::AttrCenterAnchor         = QStringLiteral("centerAnchor");
const QString MarkerTool::AttrTopAnchorPoint       = QStringLiteral("topAnchor");
const QString MarkerTool::AttrBottomAnchorPoint    = QStringLiteral("bottomAnchor");

//---------------------------------------------------------------------------------------------------------------------
MarkerTool *MarkerTool::Create(QSharedPointer<DialogTool> dialog, VMainGraphicsScene *scene,
                                               VAbstractPattern *doc, VContainer *data)
{
    SCASSERT(!dialog.isNull());
    QSharedPointer<MarkerDialog> dialogTool = dialog.objectCast<MarkerDialog>();
    ...
    MarkerTool *patternPiece = Create(0, piece, width, scene, doc, data, Document::FullParse, Source::FromGui);
...
//---------------------------------------------------------------------------------------------------------------------
MarkerTool *MarkerTool::Create(quint32 id, VPiece newPiece, QString &width, VMainGraphicsScene *scene,
                                               ...
                                               const Source &typeCreation, const QString &blockName)
{
    ...
    MarkerTool *patternPiece = nullptr;
    if (parse == Document::FullParse)
    {
        VAbstractTool::AddRecord(id, Tool::Piece, doc);
        patternPiece = new MarkerTool(doc, data, id, typeCreation, scene, blockName);
        scene->addItem(patternPiece);
        connect(patternPiece, &MarkerTool::chosenTool,           scene,        &VMainGraphicsScene::chosenItem);
        connect(scene, &VMainGraphicsScene::EnableDetailItemHover,     patternPiece, &MarkerTool::AllowHover);
        connect(scene, &VMainGraphicsScene::EnableDetailItemSelection, patternPiece, &MarkerTool::AllowSelecting);
        connect(scene, &VMainGraphicsScene::highlightPiece,            patternPiece, &MarkerTool::Highlight);
        connect(scene, &VMainGraphicsScene::pieceLockedChanged,        patternPiece, &MarkerTool::pieceLockedChanged);
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::Remove(bool ask)
{
    try
    {
        deleteTool(ask);
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::insertNodes(const QVector<VPieceNode> &nodes, quint32 pieceId, VMainGraphicsScene *scene,
                                    VContainer *data, VAbstractPattern *doc)
{
    ...
    if (pieceId > NULL_ID && !nodes.isEmpty())
    {
        ...
        for (auto node : newNodes)
        {
            ...
            MarkerTool *patternPiece = qobject_cast<MarkerTool*>(VAbstractPattern::getTool(pieceId));
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::AddAttributes(VAbstractPattern *doc, QDomElement &domElement, quint32 id, const VPiece &piece)
{
    SCASSERT(doc != nullptr);
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::AddCSARecord(VAbstractPattern *doc, QDomElement &domElement, const CustomSARecord &record)
{
    QDomElement recordNode = doc->createElement(MarkerTool::TagRecord);
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::AddCSARecords(VAbstractPattern *doc, QDomElement &domElement,
                                       const QVector<CustomSARecord> &records)
{
    if (records.size() > 0)
    {
        QDomElement csaRecordsElement = doc->createElement(MarkerTool::TagCSA);
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::AddInternalPaths(VAbstractPattern *doc, QDomElement &domElement, const QVector<quint32> &paths)
{
    if (paths.size() > 0)
    {
        QDomElement iPathsElement = doc->createElement(MarkerTool::TagIPaths);
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::addAnchors(VAbstractPattern *doc, QDomElement &domElement, const QVector<quint32> &anchors)
{
    if (anchors.size() > 0)
    {
        QDomElement anchorsElement = doc->createElement(MarkerTool::TagAnchors);
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::AddPatternPieceData(VAbstractPattern *doc, QDomElement &domElement, const VPiece &piece)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::AddPatternInfo(VAbstractPattern *doc, QDomElement &domElement, const VPiece &piece)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::AddGrainline(VAbstractPattern *doc, QDomElement &domElement, const VPiece &piece)
{
    // grainline
...
//---------------------------------------------------------------------------------------------------------------------
QString MarkerTool::getTagName() const
{
    return VAbstractPattern::TagPiece;
}

//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::ShowVisualization(bool show)
{
    Q_UNUSED(show)
}

//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::GroupVisibility(quint32 object, bool visible)
{
    Q_UNUSED(object);
    Q_UNUSED(visible);
}
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::FullUpdateFromFile()
{
    UpdateExcludeState();
    RefreshGeometry();
}
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::EnableToolMove(bool move)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::pieceLockedChanged(quint32 id, bool lock)
{
    if (m_id == id)
    {
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::AllowHover(bool enabled)
{
    setAcceptHoverEvents(enabled);
}

//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::AllowSelecting(bool enabled)
{
    setFlag(QGraphicsItem::ItemIsSelectable, enabled);
}

//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::ResetChildren(QGraphicsItem *pItem)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::Highlight(quint32 id)
{
    setSelected(m_id == id);
    RefreshGeometry();
}

void MarkerTool::updatePieceDetails()
{
    UpdatePieceLabel();
    UpdatePatternLabel();
    UpdateGrainline();
...
//******************************************************************************
void MarkerTool::UpdatePieceLabel()
{
...
//******************************************************************************
void MarkerTool::UpdatePatternLabel()
{
    const VPiece piece = VAbstractTool::data.GetPiece(m_id);
...
//******************************************************************************
void MarkerTool::UpdateGrainline()
{
    const VPiece piece = VAbstractTool::data.GetPiece(m_id);
    const VGrainlineData &data = piece.GetGrainlineGeometry();
...
//******************************************************************************
void MarkerTool::saveMovePiece(const QPointF &ptPos)
{
...
//******************************************************************************
void MarkerTool::saveResizePiece(qreal dLabelW, int iFontSize)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//******************************************************************************
void MarkerTool::savePieceRotation(qreal dRot)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//******************************************************************************
void MarkerTool::SaveMovePattern(const QPointF &ptPos)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//******************************************************************************
void MarkerTool::SaveResizePattern(qreal dLabelW, int iFontSize)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::SaveRotationPattern(qreal dRot)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::SaveMoveGrainline(const QPointF &ptPos)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::SaveResizeGrainline(qreal dLength)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::SaveRotateGrainline(qreal dRot, const QPointF &ptPos)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//******************************************************************************
void MarkerTool::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    QColor  color;
    QString lineType;
    qreal   lineWeight;
...
//---------------------------------------------------------------------------------------------------------------------
QRectF MarkerTool::boundingRect() const
{
...
//---------------------------------------------------------------------------------------------------------------------
QPainterPath MarkerTool::shape() const
{
    const VPiece piece = VAbstractTool::data.GetPiece(m_id);
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::RefreshDataInFile()
{
    ...
    if (domElement.isElement())
    {
        // Refresh only parts that we possibly need to update
        {
            ...
            const uint version = doc->GetParametrUInt(domElement, MarkerTool::AttrVersion, "1");
            if (version == 1)
            {
                const VPiece piece = VAbstractTool::data.GetPiece(m_id);
...
//---------------------------------------------------------------------------------------------------------------------
QVariant MarkerTool::itemChange(QGraphicsItem::GraphicsItemChange change, const QVariant &value)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::hoverEnterEvent(QGraphicsSceneHoverEvent *event)
{
    if (flags() & QGraphicsItem::ItemIsMovable)
    {
        SetItemOverrideCursor(this, cursorArrowOpenHand, 1, 1);
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::hoverLeaveEvent(QGraphicsSceneHoverEvent *event)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::contextMenuEvent(QGraphicsSceneContextMenuEvent *event)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::keyReleaseEvent(QKeyEvent *event)
{
    VPiece piece = VAbstractTool::data.GetPiece(m_id);
    switch (event->key())
    {
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::SetDialog()
{
    SCASSERT(!m_dialog.isNull());
    QSharedPointer<MarkerDialog> dialogTool = m_dialog.objectCast<MarkerDialog>();
    SCASSERT(!dialogTool.isNull())
...
//---------------------------------------------------------------------------------------------------------------------
MarkerTool::MarkerTool(VAbstractPattern *doc, VContainer *data, const quint32 &id,
    ...
    , m_marker(new MarkerItem(this))
{
    ...
    connect(scene, &VMainGraphicsScene::EnableToolMove, this, &MarkerTool::EnableToolMove);
    connect(scene, &VMainGraphicsScene::ItemClicked,    this, &MarkerTool::ResetChildren);
    ToolCreation(typeCreation);
    setAcceptHoverEvents(true);

    connect(m_dataLabel, &VTextGraphicsItem::itemMoved,   this, &MarkerTool::saveMovePiece);
    connect(m_dataLabel, &VTextGraphicsItem::itemResized, this, &MarkerTool::saveResizePiece);
    connect(m_dataLabel, &VTextGraphicsItem::itemRotated, this, &MarkerTool::savePieceRotation);

    connect(m_patternInfo, &VTextGraphicsItem::itemMoved,   this, &MarkerTool::SaveMovePattern);
    connect(m_patternInfo, &VTextGraphicsItem::itemResized, this, &MarkerTool::SaveResizePattern);
    connect(m_patternInfo, &VTextGraphicsItem::itemRotated, this, &MarkerTool::SaveRotationPattern);

    connect(m_grainLine, &VGrainlineItem::itemMoved,   this, &MarkerTool::SaveMoveGrainline);
    connect(m_grainLine, &VGrainlineItem::itemResized, this, &MarkerTool::SaveResizeGrainline);
    connect(m_grainLine, &VGrainlineItem::itemRotated, this, &MarkerTool::SaveRotateGrainline);

    connect(doc, &VAbstractPattern::UpdatePatternLabel, this, &MarkerTool::UpdatePatternLabel);
    connect(doc, &VAbstractPattern::patternParsed,        this, &MarkerTool::updatePieceDetails);

    connect(m_pieceScene, &VMainGraphicsScene::DimensionsChanged, this, &MarkerTool::updatePieceDetails);
    connect(m_pieceScene, &VMainGraphicsScene::LanguageChanged,   this, &MarkerTool::retranslateUi);

    updatePieceDetails();
}

//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::UpdateExcludeState()
{
    const VPiece piece = VAbstractTool::data.GetPiece(m_id);
    for (int i = 0; i< piece.GetPath().CountNodes(); ++i)
    {
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::RefreshGeometry()
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::SaveDialogChange()
{
    SCASSERT(!m_dialog.isNull());
    MarkerDialog *dialogTool = qobject_cast<MarkerDialog*>(m_dialog.data());
...
///  command.
//******************************************************************************
void MarkerTool::nodeAngleChanged(quint32 id, PieceNodeAngle type)
{
    const VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
...
//******************************************************************************
void MarkerTool::notchChanged(quint32 id, NotchData notchData)
{
    const VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    if (!oldPiece.isLocked())
    {
...
///  SavePieceOptions undo command.
//******************************************************************************
void MarkerTool::nodeExcluded(quint32 id)
{
    const VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    if (!oldPiece.isLocked())
    {
...
//******************************************************************************
void MarkerTool::nodeDeleted(quint32 id)
{
    const VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    if (!oldPiece.isLocked())
    {
...
//---------------------------------------------------------------------------------------------------------------------
VPieceItem::MoveTypes MarkerTool::FindLabelGeometry(const VPatternLabelData &labelData, qreal &rotationAngle,
...
//---------------------------------------------------------------------------------------------------------------------
VPieceItem::MoveTypes MarkerTool::FindGrainlineGeometry(const VGrainlineData &data, qreal &length,
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::initializeNodes(const VPiece &piece, VMainGraphicsScene *scene)
{
    for (int i = 0; i< piece.GetPath().CountNodes(); ++i)
    {
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::initializeNode(const VPieceNode &node, VMainGraphicsScene *scene, VContainer *data,
    ...
    switch (node.GetTypeTool())
    {
        case (Tool::NodePoint):
        {
            ...
            if (tool->parent() != parent)
            {
                ...
                connect(tool, &VNodePoint::notchChanged, parent, &MarkerTool::notchChanged, Qt::UniqueConnection);
                connect(tool, &VNodePoint::nodeAngleChanged, parent,
                        &MarkerTool::nodeAngleChanged, Qt::UniqueConnection);
                connect(tool, &VNodePoint::nodeExcluded, parent, &MarkerTool::nodeExcluded, Qt::UniqueConnection);
                connect(tool, &VNodePoint::nodeDeleted, parent, &MarkerTool::nodeDeleted, Qt::UniqueConnection);
...
QVector<VPieceNode> MarkerTool::removeDuplicateNodePoints(const VPiece &piece, const QVector<VPieceNode> &nodes,
                                                                VContainer *data)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::InitCSAPaths(const VPiece &piece)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::InitInternalPaths(const VPiece &piece)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::initializeAnchorPoints(const VPiece &piece)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::deleteTool(bool ask)
{
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::ToolCreation(const Source &typeCreation)
{
    if (typeCreation == Source::FromGui || typeCreation == Source::FromTool)
    {
        AddToFile();
...
//---------------------------------------------------------------------------------------------------------------------
bool MarkerTool::PrepareLabelData(const VPatternLabelData &labelData, VTextGraphicsItem *labelItem,
...
//---------------------------------------------------------------------------------------------------------------------
void MarkerTool::UpdateLabelItem(VTextGraphicsItem *labelItem, QPointF pos, qreal labelAngle)
{
    SCASSERT(labelItem != nullptr)
...
//******************************************************************************
void MarkerTool::editPieceProperties()
{
    QSharedPointer<MarkerDialog> dialog = QSharedPointer<MarkerDialog>(new MarkerDialog(getData(),
                                                                                   m_id, qApp->getMainWindow()));
    dialog->enableApply(true);
    m_dialog = dialog;
    m_dialog->setModal(true);
    connect(m_dialog.data(), &DialogTool::DialogClosed, this, &MarkerTool::FullUpdateFromGuiOk);
    connect(m_dialog.data(), &DialogTool::DialogApplied, this, &MarkerTool::FullUpdateFromGuiApply);
    SetDialog();
    m_dialog->show();
}
...
//******************************************************************************
void MarkerTool::toggleInLayout(bool checked)
{
...
//******************************************************************************
void MarkerTool::togglePieceLock(bool checked)
{
...
//******************************************************************************
void MarkerTool::toggleFlipping(bool checked)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//******************************************************************************
void MarkerTool::toggleSeamLine(bool checked)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//******************************************************************************
void MarkerTool::toggleSeamAllowance(bool checked)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//******************************************************************************
void MarkerTool::toggleGrainline(bool checked)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//******************************************************************************
void MarkerTool::togglePatternLabel(bool checked)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//******************************************************************************
void MarkerTool::togglePieceLabel(bool checked)
{
    VPiece oldPiece = VAbstractTool::data.GetPiece(m_id);
    VPiece newPiece = oldPiece;
...
//******************************************************************************
void MarkerTool::renamePiece(VPiece piece)
{
...
void MarkerTool::showStatus(QString toolTip)
{
...
void MarkerTool::raiseItemToTop(QGraphicsItem *item)
{
    if (item)
    {
...
void MarkerTool::lowerItemToBottom(QGraphicsItem *item)
{
    if (item != nullptr)
    {
