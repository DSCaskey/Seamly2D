    ...
    if (object1Id > NULL_ID)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    QLineF const cursorLine(static_cast<QPointF>(*first), Visualization::scenePos);

                    qreal const len = cursorLine.length();
                    QPointF const fPoint = VToolShoulderPoint::findPoint(static_cast<QPointF>(*second),
                                                                         static_cast<QPointF>(*third),
                    ...
                    Visualization::toolTip = tr("<b>Length to Line</b>: length = %1%2, "
                                                ...
                                                .arg(qApp->translateVariables()->FormulaToUser(QString::number(qApp->fromPixel(len)),
